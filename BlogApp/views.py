...
from django.core.mail import send_mail
#   send_mail('Hello', 'Very imp msg....','prasanth369.g@gmail.com',['jamalesh.p@gmail.com','nagarajupodili7@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'prasanth369.g@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
	    form=EmailSendForm()
